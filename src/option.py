...
# HIVAU supervision
parser.add_argument('--hivau-json', default='../HIVAU-70k-NEW/ucf_database_train_filtered.json')
...
parser.add_argument('--boundary-margin', default=0, type=int)
parser.add_argument('--label-smooth', default=0.0, type=float)
parser.add_argument('--ensemble-alpha', default=0.5, type=float)
