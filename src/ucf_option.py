...
parser.add_argument('--lambda-frame', default=0.5, type=float)
parser.add_argument('--mu-smooth', default=0.1, type=float)
parser.add_argument('--normal-target', default=0.1, type=float)
parser.add_argument('--gauss-sigma', default=3.0, type=float)
